...
# DATA_ROOT = './examples/coco_caption/coco'
sys.path.append('./')
DATA_ROOT = './coco'

COCO_PATH = '%s/coco' % DATA_ROOT
COCO_TOOL_PATH = '%s/coco-tools/PythonAPI' % COCO_PATH
...
COCO_IMAGE_PATTERN = '%s/%%s2014' % COCO_PATH
COCO_IMAGE_ID_PATTERN = 'COCO_%s2014_%%012d.jpg'

BUFFER_SIZE = 100
OUTPUT_DIR = '%s/h5_data/buffer_%d' % (COCO_PATH, BUFFER_SIZE)
SPLITS_PATTERN = '%s/coco2014_cocoid.%%s.txt' % (DATA_ROOT)
